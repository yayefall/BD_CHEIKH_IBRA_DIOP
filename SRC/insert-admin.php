...
if (!$insert){ // Contrôler la connexion
    ...
    }else { echo "cette extention n'est pas autorisée";}
       
    
    $role="admin";
    $avatar=$file_dest;
    $admin=$insert->prepare("INSERT INTO user (id,login,nom,prenom,password,avatar,role) VALUES (NULL,'$login','$nom','$prenom','$password','$avatar','$role')");
    $admin->execute();
